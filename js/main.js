...
// NUEVA: Función para actualizar los detalles de un dispositivo (nombre, tipo, ubicación)
...
// NUEVA: Función para eliminar un dispositivo
...
function renderDeviceCard(device) {
    ...
    // MODIFICADO: Se añaden botones de Editar y Eliminar
    return `
        <div class="col">
...
// Función para renderizar todos los dispositivos
...
// Función para renderizar la tabla de dispositivos recientes
...
// NUEVA: Función centralizada para añadir los event listeners a los botones
...
// Event listener para el formulario de EDITAR dispositivo
...
// NUEVA: Función para refrescar toda la UI
